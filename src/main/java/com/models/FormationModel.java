...
public class FormationModel {
	...
	public FormationModel(int defenders, int defensiveMidfielders, int attackingMidfielders, int forwards,
			FormationType type) {
		try {
	...
	private void checkFormationValidity(int defenders, int midfielders, int forwards) throws FormationInvalidException {
		if (defenders >= Constants.DEFENDERS_MIN && defenders <= Constants.DEFENDERS_MAX
				&& midfielders >= Constants.MIDFIELDERS_MIN && midfielders <= Constants.MIDFIELDERS_MAX
				&& forwards >= Constants.FORWARDS_MIN && forwards <= Constants.FORWARDS_MAX
	...
	private void checkFormationValidity(int defenders, int defensiveMidfielders, int attackingMidfielders, int forwards)
			throws FormationInvalidException {
		if (defenders >= Constants.DEFENDERS_MIN && defenders <= Constants.DEFENDERS_MAX
				&& defensiveMidfielders >= Constants.DEFENSIVE_MIDFIELDERS_MIN
				&& defensiveMidfielders <= Constants.DEFENSIVE_MIDFIELDERS_MAX
				&& attackingMidfielders >= Constants.ATTACKING_MIDFIELDERS_MIN
				&& attackingMidfielders <= Constants.ATTACKING_MIDFIELDERS_MAX && forwards >= Constants.FORWARDS_MIN
				&& forwards <= Constants.FORWARDS_MAX
