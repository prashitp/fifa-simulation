...
public class CornerKickControllerTest {
    ...
    public void getCornerKicksTypeTest(){
        ICornerKickController cornerKick = new CornerKickController(team1,team2);
        assertEquals("List12",cornerKick.getCornerKicks().getClass().getSimpleName());
    }
}
