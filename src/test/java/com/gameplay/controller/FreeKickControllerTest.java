...
public class FreeKickControllerTest {
    ...
    public void getCornerKicksTypeTest(){
        IFreeKickController freeKick = new FreeKickController(team1,team2);
        assertEquals("List12", freeKick.getFreeKicks().getClass().getSimpleName());
    }
}
